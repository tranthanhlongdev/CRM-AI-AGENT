      ...
      <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-orange-50 to-orange-100 px-4 sm:px-6 py-3 sm:py-4 border-b border-orange-200">
          <div className="flex items-center">
            <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-orange-500 text-white flex items-center justify-center mr-3">
              <svg
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <h4 className="text-sm sm:text-base font-medium text-gray-900">
                  Danh mục khoản vay (
                  {
                    loanAccounts.filter((loan) => loan.status === "active")
                      .length
                  }{" "}
                  đang hoạt động)
                </h4>
              ...
              {overdueDebts.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-4 sm:gap-6">
                  {overdueDebts.map((debt) => (
                    <div
                      key={debt.id}
                      className="bg-gradient-to-r from-red-50 to-red-100 border border-red-200 rounded-lg sm:rounded-xl p-4 sm:p-6"
                    >
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4 gap-3">
                        <div className="flex items-center space-x-3">
