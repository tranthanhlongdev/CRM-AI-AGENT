          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-blue-600">
                Quản lý tài khoản thanh toán và sao kê
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
                {paymentAccounts.map((account) => (
                  <div
                    key={account.id}
                    className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-5 hover:shadow-md transition-all duration-200"
                  >
                    {/* Account Header */}
