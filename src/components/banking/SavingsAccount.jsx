      ...
      <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-green-50 to-green-100 px-4 sm:px-6 py-3 sm:py-4 border-b border-green-200">
          <div className="flex items-center">
            <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-green-500 text-white flex items-center justify-center mr-3">
              <svg
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-green-600">
                Quản lý tài khoản tiết kiệm và tất toán
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6">
                {savingsAccounts.map((account) => (
                  <div
                    key={account.id}
                    className="bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-lg sm:rounded-xl p-4 sm:p-6"
                  >
                    {/* Account Header */}
